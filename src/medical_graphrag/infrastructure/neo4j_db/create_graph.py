"""Script to create and populate Neo4j graph from medical papers dataset."""

import json
from pathlib import Path

from medical_graphrag.domain.dataset import GeneDataset, PaperDataset
from medical_graphrag.infrastructure.neo4j_db.neo4j_client import AsyncNeo4jClient
from medical_graphrag.infrastructure.neo4j_db.neo4j_graph_schema import Neo4jGraphIngestion
