...
from medical_graphrag.config import Neo4jSettings, QdrantSettings
from medical_graphrag.infrastructure.neo4j_db.neo4j_client import AsyncNeo4jClient
from medical_graphrag.infrastructure.qdrant_db.qdrant_vectorstore import AsyncQdrantVectorStore
...
class TestQdrantIntegration:
    ...
    async def test_qdrant_vectorstore_initialization(self) -> None:
        ...
        with patch(
            ...
            with patch(
                "medical_graphrag.infrastructure.qdrant_db.qdrant_vectorstore.AsyncQdrantClient"
...
class TestNeo4jIntegration:
    ...
    async def test_neo4j_client_creation(self) -> None:
        ...
        with patch("medical_graphrag.infrastructure.neo4j_db.neo4j_client.settings") as mock_settings:
            ...
            with patch(
                "medical_graphrag.infrastructure.neo4j_db.neo4j_client.AsyncGraphDatabase"
            ) as mock_db:
