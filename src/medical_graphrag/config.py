...
class Neo4jSettings(BaseModel):
    uri: str = Field(
        default="neo4j+s://dede6202.databases.neo4j.io", description="URI for Neo4j database"
    )
...
class QdrantSettings(BaseModel):
    url: str = Field(
        default="hhttps://81aa4bd8-2917-479d-9669-cf19051b3b8a.sa-east-1-0.aws.cloud.qdrant.io:6333",
        description="URL for Qdrant instance",
    )
